...
internal class BowBlackmetal
{
	...
	private static void AddRecipe()
	{
		...
		customRecipe = new CustomRecipe(recipe, fixReference: false, fixRequirementReferences: true);
	...
	{
		customItem = new CustomItem(AssetHelper.BowBlackmetalPrefab, fixReference: true);
